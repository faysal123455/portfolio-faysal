...
const HeroSection = () => {
  return (
    <section id="about" className="min-h-screen pt-20 flex flex-col justify-center bg-gradient-to-b from-white to-navy-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 animate-fade-in">
            ...
            <p className="text-lg text-navy-800 mb-8 max-w-2xl">
              ...
              demonstrating effective problem-solving skills and utilizing strong presentation skills and data analysis abilities.
            </p>
