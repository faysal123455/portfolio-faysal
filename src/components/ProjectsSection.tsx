  ...
  const projects = [
    {
      ...
      description:
        "Developed an RNN-based NLP model to predict sentence emotions with 82% accuracy.",
    ...
    },
    {
      ...
      description:
        "Created a GAN model to convert handwriting styles in real-time with 89% accuracy.",
    ...
    },
    {
      ...
      description:
        "Developed a CNN-based AI system for automatic attendance tracking in enterprises. Integrated Flask and MySQL, reducing manual effort by 60% with 87% recognition accuracy.",
    ...
    },
    {
      ...
      description:
        "Developed a predictive analytics model for the education industry to assess student performance based on study patterns. Used Machine Learning to achieve 92% accuracy, assisting educators in curriculum adjustments.",
    ...
    },
    {
      ...
      description:
        "Developing an AI-driven mental health chatbot to detect distress signals in conversations. Using Seq2Seq and Natural Language Processing to provide empathetic responses and support users in mental health awareness initiatives.",
